...
GH_ASSET_PATH="$artifacts_path/DatadogApollo.xcframework.zip"
REPO_NAME="DataDog/dd-sdk-ios-apollo-interceptor"
...
export GITHUB_TOKEN=$(dd-octo-sts --disable-tracing token --scope DataDog/dd-sdk-ios-apollo-interceptor --policy self.release)
verify_gh_auth
upload
