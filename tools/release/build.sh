...
REPO_CLONE_PATH="$ARTIFACTS_PATH/dd-sdk-ios-apollo-interceptor"
XCF_DIR_NAME="DatadogApollo.xcframework"
XCF_ZIP_NAME="DatadogApollo.xcframework.zip"
...
clone_repo () {
    ...
    git clone --depth 1 --branch $tag --single-branch git@github.com:DataDog/dd-sdk-ios-apollo-interceptor.git $REPO_CLONE_PATH
}
